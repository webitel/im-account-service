...
const (
	Account_Token_FullMethodName             = "/webitel.im.internal.auth.v1.Account/Token"
	Account_Logout_FullMethodName            = "/webitel.im.internal.auth.v1.Account/Logout"
	Account_Inspect_FullMethodName           = "/webitel.im.internal.auth.v1.Account/Inspect"
	Account_RegisterDevice_FullMethodName    = "/webitel.im.internal.auth.v1.Account/RegisterDevice"
	Account_UnregisterDevice_FullMethodName  = "/webitel.im.internal.auth.v1.Account/UnregisterDevice"
	Account_GetAuthorizations_FullMethodName = "/webitel.im.internal.auth.v1.Account/GetAuthorizations"
)
...
func (c *accountClient) Token(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*Authorization, error) {
	...
	err := c.cc.Invoke(ctx, Account_Token_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accountClient) RegisterDevice(ctx context.Context, in *RegisterDeviceRequest, opts ...grpc.CallOption) (*RegisterDeviceResponse, error) {
	...
	err := c.cc.Invoke(ctx, Account_RegisterDevice_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accountClient) UnregisterDevice(ctx context.Context, in *UnregisterDeviceRequest, opts ...grpc.CallOption) (*UnregisterDeviceResponse, error) {
	...
	err := c.cc.Invoke(ctx, Account_UnregisterDevice_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accountClient) GetAuthorizations(ctx context.Context, in *GetAuthorizationRequest, opts ...grpc.CallOption) (*AuthorizationList, error) {
	...
	err := c.cc.Invoke(ctx, Account_GetAuthorizations_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var Account_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "webitel.im.internal.auth.v1.Account",
	...
	Metadata: "internal/auth/v1/service_account.proto",
}
